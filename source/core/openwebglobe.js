...
goog.exportSymbol('engine3d.GetDirectionMousePos', engine3d.GetDirectionMousePos);
goog.exportSymbol('engine3d.InitEngine', engine3d.InitEngine);
goog.exportSymbol('engine3d.LoadMesh', engine3d.LoadMesh);
goog.exportSymbol('engine3d.LoadTexture', engine3d.LoadTexture);
goog.exportSymbol('engine3d.PopMatrices', engine3d.PopMatrices);
goog.exportSymbol('engine3d.PushMatrices', engine3d.PushMatrices);
...
goog.exportSymbol('engine3d.SetMouseDownCallback', engine3d.SetMouseDownCallback);
goog.exportSymbol('engine3d.SetMouseMoveCallback', engine3d.SetMouseMoveCallback);
goog.exportSymbol('engine3d.SetMouseUpCallback', engine3d.SetMouseUpCallback);
